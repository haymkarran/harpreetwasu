...
import theHarpreetTimes from "../../../public/assets/logos/The Harpreet Times.svg"
...
const TopNav: React.FC<Props> = () => {
    ...
    useEffect(() => {
      ...
      // checking for scroll Y position
    ...
    return (
        <>
            <header className={`header antialiase id="main_header" bg-background/50 dark:bg-foreground/20 backdrop-blur-xl ${isVisible ? 'visible' : 'hidden'} ${isFixed ? 'fixed' : ''}`}>
                ...
                <div className="flex flex-row justify-between items-center">
                    <div className="header-item item-left flex-row">
                        ...
                        <div className="logo">
                            ...
                            >
                                <img className='harpreet-logo invert-0 brightness-0 dark:invert'
                                src={svg.src}
                                alt="Harpreet Wasu"
                    ...
                    <div className="header-item item-center">
                        ...
                        <nav className="menu" onClick ={clickedMenuMain}>
                                                        ...
                                                        <div className='flex flex-row gap-x-4 items-start'>
                                                            ...
                                                            {contentsData.videoSrcImage && (
                                                                <div className='flex-none overflow-hidden rounded-md w-32 h-20 bg-gray-200 relative border border-gray-200 dark:bg-gray-900 dark:border-gray-800'>
                                                                    ...
                                                                    <img src={playbtn.src} className='w-14 h-14 object-contain playButton absolute'></img>
                                                                </div>
                                                            )}
                                                            <div className=''>
                            ...
                            <li className="menu-item-has-children themeSwitchBtn">
                                <ThemeSwitch />
                            </li>
                            <li className="menu-item-has-children">
